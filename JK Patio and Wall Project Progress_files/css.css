...
.button {
	...
	color:#FFFFFF;
	background:#000000 url(images/gradients/generic_button.png) repeat-x top left;
	-moz-border-radius:0px;
	-webkit-border-radius:0px;
	webkit-border-radius:0px;
}
...
.blockhead {
	font:  normal 12px Tahoma, Calibri, Verdana, Geneva, sans-serif;
	color:#ffffff;
	background:#292621 url(images/buttons/newbtn_middle.png) repeat-x  ;
...
.blocksubhead {
	font:  normal 12px ;
	color:#3e3e3e;
	background:#998F82 none repeat-x  ;
	padding:4px 10px 4px 10px;
...
/*.blockhead + */.blockbody { /* not sure why I had this .blockhead + .blockbody selector... need to look out for breakage */
	background:#998F82 none no-repeat  ;
	padding-left:0px;
	padding-right:0px;
}
...
.blockrow a { color:#626268; }
.blockrow a:hover { color:; }

.blockfoot, .blocksubfoot {
	display:block;
	clear:both;
	background:#998F82 none   ;
...
dl.tabslight dd a:hover {
	color:#473D2F;
	background:#000000 url(images/gradients/selected-tab-gradient-with-top-alpha.png) repeat-x 0 -4px;
}
...
.above_body {
	background:#726049 url(images/gradients/gradient-grey-down.png) repeat-x  ;
	_background-image: none;
...
.toplinks ul.isuser .notifications .popupbody {
	background: #473D2F;
	border: 1px solid #473D2F; /* makes it look consistent with the popup background */
}
...
.toplinks ul.isuser .notifications .popupbody li a{
	...
	font-weight: normal;
	background:rgb(255, 255, 255);
	border-top:1px solid #473D2F; /* makes it look consistent with the popup background */
	/*position: relative;*/
	text-align: left;
	padding-left: 30px;
	line-height: 26px;
...
.navtabs {
	background:#473D2F url(images/buttons/newbtn_middle.png) repeat-x  ;
...
.navtabs li.selected a.navtab {
	color:#000000;
	background:#000000 url(images/gradients/selected-tab-gradient-with-top-alpha.png) repeat-x  ;
        _background-image:none;
	position:relative;
	top:-4px;
	padding-top:4px;
...
.toplinks .notifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl.active , .toplinks .notifications a.popupctrl.active{
	...
	padding-left: 4px;
	padding-right: 15px;
	background: #473D2F url(images/misc/arrow.png) no-repeat right center;
        _background-image:url('images/misc/arrow.gif');
}
...
.newcontent_textcontrol {
	background: #000000 url(images/buttons/newbtn_middle.png) repeat-x left top;
	_background-image: none;
...
.newcontent_textcontrol:hover {
	background: #473D2F url(images/buttons/newbtn_middle.png) repeat-x left top;
	_background-image: none;
	color: rgb(255, 255, 255);
	text-decoration: none;
}
